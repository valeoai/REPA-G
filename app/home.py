...
from potential import RepaPotential, FreeEnergy, MultiPotential, MeanFeatAlignment
...
if __name__ == "__main__":
    ...
    st.title("Custom Image Conditioning")
    ...
    with st.sidebar:
        ...
        folder_path = st.text_input("Image Folder Path", value="app/ressources")
        ...
        sampling_mode = st.selectbox("Sampling Mode", ["ode", "sde"], index=1)
        num_steps = st.slider("Number of Steps", 1, 250, 250, step=1)
